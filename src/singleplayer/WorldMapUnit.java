...
public class WorldMapUnit extends GraphicalGameUnit{
	...
	public void drawComponent(Graphics g) {
		...
		mapCanvas = new BufferedImage(worldMap.getMap().getWidth(), worldMap.getMap().getHeight(), BufferedImage.TYPE_INT_ARGB);
	...
	private void updatePlayerPosition() {
		...
		worldMap.getMap().getMapPlayer().setPosX(GameConstants.TILE_SIZE * playerCoord.x);
		worldMap.getMap().getMapPlayer().setPosY(GameConstants.TILE_SIZE * playerCoord.y);		
	}
